...
// Start priority update code
function resetPriority(id, old_priority, table_name, update_field, where_field) {


    var new_priority = prompt("Priority reset ", old_priority);
    ...
    if (new_priority == old_priority)
    {
        ...
        data.update_field = update_field;
        data.new_priority = new_priority;
        data.where_field = where_field;
        data.action = 'priority_reset';
        var url = baseUrl + 'admin/ajax/priority_update.php';
        $.ajax({
            type: "POST",
            url: url,
            data: data,
            success: function(res) {
                res = $.parseJSON(res);
                if (res.error == 0 && res.message == 1) {
                    $("td#priority_data_" + id).html('<a href="javascript:resetPriority(\'' + id + '\',\'' + new_priority + '\',\'' + table_name + '\',\'' + update_field + '\',\'' + where_field + '\');">' + new_priority + '</a>');
