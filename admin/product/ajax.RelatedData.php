                                ...
                                ->setCellValue('H1', 'product_meta_keywords')
                                  ->setCellValue('I1', 'product_meta_description')
                                    ->setCellValue('J1', 'product_tags')
                                      ->setCellValue('K1', 'product_priority');//write in the sheet
                                  ...
                                  ->setCellValue('H'.$Line, $resultGetProductObj->product_meta_keywords)
                                    ->setCellValue('I'.$Line, $resultGetProductObj->product_meta_description)
                                      ->setCellValue('J'.$Line, $tags)
                                        ->setCellValue('K'.$Line, $resultGetProductObj->product_priority);//write in the sheet
    ++$Line;
}
...
//
//$objPHPExcel->createSheet(); //creating a new sheet
//$objPHPExcel->setActiveSheetIndex(2); //setting sheet index
...
$getCellValueSheet5->setCellValue('A1', 'PI_id')
                    ->setCellValue('B1', 'PI_inventory_title')
                      ->setCellValue('C1', 'PI_product_id')
                        ->setCellValue('D1', 'product_title')
                          ->setCellValue('E1', 'PI_size_id')
                            ->setCellValue('F1', 'size_title')
                              ->setCellValue('G1', 'PI_quantity')
                                ->setCellValue('H1', 'PI_cost')
                                  ->setCellValue('I1', 'PI_old_price')
                                    ->setCellValue('J1', 'PI_current_price');//write in the sheet
...
$getCellValueSheet5->getStyle('E1')->applyFromArray($styleArray);
$getCellValueSheet5->getStyle('F1')->applyFromArray($styleArray);
$getCellValueSheet5->getStyle('G1')->applyFromArray($styleArray);
$getCellValueSheet5->getStyle('H1')->applyFromArray($styleArray);
$getCellValueSheet5->getStyle('I1')->applyFromArray($styleArray);
$getCellValueSheet5->getStyle('J1')->applyFromArray($styleArray);
...
while($resultGetProductInventoryObj=mysqli_fetch_object($resultGetProductInventory)){//extract each record
    $getCellValueSheet5->setCellValue('A'.$Line, $resultGetProductInventoryObj->PI_id)
                        ->setCellValue('B'.$Line, $resultGetProductInventoryObj->PI_inventory_title)
                          ->setCellValue('C'.$Line, $resultGetProductInventoryObj->PI_product_id)
                            ->setCellValue('D'.$Line, $resultGetProductInventoryObj->product_title)
                              ->setCellValue('E'.$Line, $resultGetProductInventoryObj->PI_size_id)
                                ->setCellValue('F'.$Line, $resultGetProductInventoryObj->size_title)
                                  ->setCellValue('G'.$Line, $resultGetProductInventoryObj->PI_quantity)
                                    ->setCellValue('H'.$Line, $resultGetProductInventoryObj->PI_cost)
                                      ->setCellValue('I'.$Line, $resultGetProductInventoryObj->PI_old_price)
                                        ->setCellValue('J'.$Line, $resultGetProductInventoryObj->PI_current_price);//write in the sheet
    ++$Line;
}
