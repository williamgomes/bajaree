...
if (isset($_POST['update'])) {
    ...
    if ($pcost == "") {
        ...
        $UpdatePrice .= ', product_discount = "' . mysqli_real_escape_string($con, $discount) . '"';
        $UpdatePrice .= ', product_updated_by = "' . mysqli_real_escape_string($con, $aid) . '"';

        $UpdatePriceSQL = "UPDATE products SET $UpdatePrice WHERE product_id=$pid ";
                    ...
                    <div class="body">
                        <div class="charts" style="width: 700px; height: auto;">
                            <form action="price.php?pid=<?php echo base64_encode($pid); ?>" method="post" class="mainForm">
                                ...
                                <fieldset>
                                    <div class="widget first">
                                        <div class="head"><h5 class="iList">Price Information</h5></div>
                                        <div class="rowElem noborder"><label>Production Cost:</label><div class="formRight">
                                        ...
                                        <div class="rowElem noborder"><label>Discount amount:</label><div class="formRight">
                                                <input name="dprice" type="text" maxlength="20" value="<?php echo $rowproduct['product_discount']; ?>"/>
                                            </div><div class="fix"></div></div>
