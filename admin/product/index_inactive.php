...
if (isset($_GET['sortBy'])) {
    ...
    $productSql = "SELECT * FROM products LEFT JOIN product_categories ON product_categories.PC_product_id = products.product_id WHERE product_status='inactive' AND  product_categories.PC_category_id IN ($childString)";
}else{
    $productSql = "SELECT * FROM products WHERE product_status='inactive'";
}
        ...
        <script type="text/javascript">
            function active(pin_id) {
                jConfirm('You want to ACTIVATE this?', 'Confirmation Dialog', function(r) {
                    if (r) {
                        /*alert(r); */
                        window.location.href = 'index_inactive.php?actid=' + pin_id;
                    }
                });
            }
        </script>
        ...
        <script type="text/javascript">
            function inactive(pin_id) {
                jConfirm('You want to DEACTIVATE this?', 'Confirmation Dialog', function(r) {
                    if (r) {
                        /*alert(r);*/
                        window.location.href = 'index_inactive.php?inactid=' + pin_id;
                    }
                });
            }
            ...
            $(document).ready(function() {
                $("#sortByCat").live('change', function() {
                    ...
                    //alert(sortByCatId);
                    window.location.href = 'index_inactive.php?sortBy=' + sortByCatId;
                });
            });
        </script>
        <!--Deactivation Script -->
...
<!--                                <th>Price</th>-->
        ...
        <!--                                        <td><?php // echo $productArray[$i]->product_price;     ?></td>-->
                                        <td><?php
