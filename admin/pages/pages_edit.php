                            ...
                            <form action="<?php echo baseUrl('admin/pages/pages_edit.php?id=') . base64_encode($edit_page_id); ?>" method="post" enctype="multipart/form-data" class="mainForm">
                                ...
                                <fieldset>
                                    <div class="widget first">
                                        ...
                                        <div class="rowElem noborder"><label> Pages URL:</label><div class="formRight"><input type="text" name="page_url" id="page_url" value="<?php echo $page_url; ?>" <?php if ($page_type == 'built-in') {
                                        echo 'readonly';
                                        ...
                                        <div><textarea class="tm" rows="5" cols="" name="page_meta_description"><?php echo $page_meta_description; ?></textarea></div>
