                            ...
                            <form action="index.php" method="post" class="mainForm" enctype="multipart/form-data" >
                                ...
                                <fieldset>
                                    <div class="widget first">
                                        ...
                                        <div class="head"><h5 class="iPencil">Category Banner Description:</h5></div>      
...
while ($catbanrow = mysqli_fetch_array($catbansql)) {
    ?>                        
                                            ...
                                            <tr class="gradeA">
                                                ...
                                                <td><?php echo getFieldValue('categories', 'category_name', 'category_id=' . $catbanrow['CB_category_id']); ?> <?php if($catbanrow['CB_category_id'] == 2){ echo '(Root Category)'; } ?></td>
                                                ...
                                                <td id='priority_data_<?php echo $catbanrow['CB_id']; ?>'><a href='javascript:resetPriority("<?php echo $catbanrow['CB_id']; ?>","<?php echo $catbanrow['CB_priority']; ?>","category_banners","CB_priority","CB_id")' ><?php echo $catbanrow['CB_priority']; ?></a></td>
