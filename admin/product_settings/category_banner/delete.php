...
if($delimg)
{
	...
	while ($catbanrow = mysqli_fetch_array($catbansql)) 
	{
                                            ...
                                            <td>'.getFieldValue('categories', 'category_name', 'category_id=' . $catbanrow['CB_category_id']);
                                                if($catbanrow['CB_category_id'] == 2){ echo '(Root Category)'; }
                                            echo '</td>
											...
											echo $adminrow[0];
											echo '</td>
                                            <td><a href="edit.php?pid='.base64_encode($catbanrow['CB_id']).'" title="Edit"><img src="'.baseUrl().'admin/images/edit.png" height="12px" width="12px" /></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:delid('.$catbanrow['CB_id'].');" title="Delete"><img src="'.baseUrl().'admin/images/delete.png" height="12px" width="12px" /></a></td>
                                        </tr>';
	}
                                 echo '</tbody>
                            </table>';
...
else
{
	...
	while ($catbanrow = mysqli_fetch_array($catbansql)) 
	{
                                            ...
                                            <td>';
                                                  ...
                                                  echo $adminrow[0];
                                                  echo '</td>
                                            <td><a href="edit.php?pid='.base64_encode($catbanrow['CB_id']).'" title="Edit"><img src="'.baseUrl().'admin/images/edit.png" height="12px" width="12px" /></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:delid('.$catbanrow['CB_id'].');" title="Delete"><img src="'.baseUrl().'/images/delete.png" height="12px" width="12px" /></a></td>
                                        </tr>';
	}
                                 echo '</tbody>
                            </table>';
