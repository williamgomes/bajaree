...
$sqlGetPage = "SELECT * FROM pages WHERE page_id=2";
...
<?php include basePath('header_menu.php'); ?>
      ...
      <div class="row" style="margin:0;">
        <div class="about_banner">
          ...
          <p>Let us worry about your kitchen and household<br>while you enjoy everything else in life.</p></div>
      </div>
      <div class="w100 mainContainer contactPage ">

        <div class="container">
          <div class=" col-sm-6 col-xs-4 main-column">
            <div class="about_cntImg"> 
              <p align="right"><img width="150" src="images/about_img.jpg" alt="map"></p>
            </div>

          </div>

          <div class=" col-sm-6 col-xs-8 main-column">
            <div class="about_content"> 
              <p> Content Coming Soon ... </p>
             <p><span><span>BAJAREE<br>Suite 1C, House 3B, Road 49,<br> Gulshan-2, Dhaka – 1212, Bangladesh<br><span><span>Hotline- 01760226700</span></span><br>www.bajaree.com<br></span><br></span></p>
            </div>
