...
class Pagination {
    ...
    function ajaxCategoryPagination($url = NULL, $location = NULL, $index = 3) {
        ...
        $output[] = '<li><a href="javascript:void(0);" onClick="ajaxCategoryPagination(\'' . $this->setPage($url, $prev_page) . '\',\'' . $location . '\');">&laquo;</a></li>';
        if ($this->total_pages > (($index * 2) + 3) && $this->page >= ($index + 3)) {
            $output[] = '<li class="link-li"><a class="link-nav" href="javascript:void(0);"  onClick="ajaxCategoryPagination(\'' . $this->setPage($url, 1) . '\',\'' . $location . '\');">1</a></li>';
            $output[] = '<li class="link-li"><a class="link-nav" href="javascript:void(0);"  onClick="ajaxCategoryPagination(\'' . $this->setPage($url, 2) . '\',\'' . $location . '\');">2</a></li>';
        }
        if ($this->page > $index + 3)
            $output[] = '<li class="link-li"><span style="color:#5683AA;" >- - -</span></li>';
        for ($i = 1; $i <= $this->total_pages; $i++) {
            if ($this->page == $i)
                $output[] = '<li class="link-li active"><a class="link-nav " href="javascript:void(0);"  onClick="ajaxCategoryPagination(\'' . $this->setPage($url, $i) . '\',\'' . $location . '\');" >' . $i . '</a></li>';

            elseif (($i >= ($this->page - $index) && $i < $this->page) or ($i <= ($this->page + $index) && $i > $this->page))
                $output[] = '<li class="link-li"><a class="link-nav" href="javascript:void(0);"  onClick="ajaxCategoryPagination(\'' . $this->setPage($url, $i) . '\',\'' . $location . '\');" >' . $i . '</a></li>';
        }

        if ($this->page < ($this->total_pages - 6))
            $output[] = '<li class="link-li"><span style="color:#5683AA;" >- - -</span></li>';
        if ($this->total_pages > (($index * 2) + 3) && $this->page <= $this->total_pages - ($index + 3)) {
            $output[] = '<li class="link-li"><a class="link-nav" href="javascript:void(0);"  onClick="ajaxCategoryPagination(\'' . $this->setPage($url, $this->total_pages - 2) . '\',\'' . $location . '\');" >' . ($this->total_pages - 2) . '</a></li>';
            $output[] = '<li class="link-li"><a class="link-nav" href="javascript:void(0);"  onClick="ajaxCategoryPagination(\'' . $this->setPage($url, $this->total_pages - 1) . '\',\'' . $location . '\');" >' . ($this->total_pages - 1) . '</a></li>';
        }

        $output[] = '<li><a  href="javascript:void(0);"  onClick="ajaxCategoryPagination(\'' . $this->setPage($url, $next_page) . '\',\'' . $location . '\');" >&raquo;</a></li>';
